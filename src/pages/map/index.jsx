      ...
      <div >
        ...
        <div className="map-wrapper ">
          ...
          <div className="map-statistic-wrapper">
            <h3 className=" map-region-heading ">
              {mapRegion}
            </h3>

            <div className=" map-new ">
              <div className="map-new-text ">
                <p className=" map-smart-water-desc">Smart Water</p>
                <p className=" map-smart-water-desc-stat">{waterTotal}</p>
              </div>

              <div className="map-new-texts">
                <p className=" map-smart-water-desc">Smart Well</p>
                <p className=" map-smart-water-desc-stat">{wellTotal}</p>
              </div>
            </div>
          </div>
        </div>
