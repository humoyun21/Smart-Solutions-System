        ...
        <Container>
          <Row gutter={[16, 16]} className="second">
            <Col xs={24} sm={12} md={6} className="second-all">
              <Card hoverable cover={<img alt="Icon1" src={Icon1} />}>
                <Meta
                  title="ALL PRODUCTS"
                  description="Discover our advantage. Offering the widest range of monitoring solutions in the industry."
                />
              </Card>
            </Col>
            <Col xs={24} sm={12} md={6} className="second-all">
              <Card hoverable cover={<img alt="Icon2" src={Icon2} />}>
                <Meta
                  ...
                  description="Explore our download center. Find everything from product brochures to our software files."
                />
              </Card>
            </Col>
            <Col xs={24} sm={12} md={6} className="second-all">
              <Card hoverable cover={<img alt="Icon3" src={Icon3} />}>
                <Meta
                  title="SUPPORT"
                  description="Learn from some of the top technical minds in the industry and get the support you need."
                />
              </Card>
            </Col>
            <Col xs={24} sm={12} md={6} className="second-all">
              <Card hoverable cover={<img alt="Icon4" src={Icon4} />}>
                <Meta
                  title="CONTACT US"
                  description="We want to hear from you. We love learning about your projects and creating new partnerships."
                />
              </Card>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 16]} className="about">
            <Col xs={24} md={12} className="about-us">
              ...
              <h4>
                RST was founded in 1977, when Robert Straghan Sr. built a better
                pneumatic piezometer. We’ve come a long way since then, but some
                things haven’t changed. Relentless curiosity and a drive to
                solve exciting problems still fuel us.
                <br />
                <br />
                In our bustling lab, we’re continually devising original
                solutions to evolving engineering challenges. Our sensors enable
                the next generation of projects so you can go places you’ve
                never been before with confidence.
                <br />
                <br />
                For over 40 years, RST’s pioneering technologies have enabled
                iconic infrastructure projects, including dams, tunnels,
                bridges, and more. From our base in Western Canada, we’ve grown
                a reputation for right-fit solutions that span the lifecycle of
                your project, from designing and building to training,
                installing, inspecting and updating monitoring systems. That’s a
